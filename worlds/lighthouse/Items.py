...
item_data_table: dict[Items, LighthouseItemData] = {
    ...
    Items.NOTE_BUBBLEGLOOP_SWAMP: LighthouseItemData(92, IC.progression, 0, tags=GroupTag.Note),
    Items.NOTE_CLANKERS_CAVERN: LighthouseItemData(93, IC.progression, 0, tags=GroupTag.Note),
    Items.NOTE_CLICK_CLOCK_WOOD: LighthouseItemData(94, IC.progression, 0, tags=GroupTag.Note),
    Items.NOTE_FREEZEEZY_PEAK: LighthouseItemData(95, IC.progression, 0, tags=GroupTag.Note),
    Items.NOTE_GOBIS_VALLEY: LighthouseItemData(96, IC.progression, 0, tags=GroupTag.Note),
    Items.NOTE_MAD_MONSTER_MANSION: LighthouseItemData(97, IC.progression, 0, tags=GroupTag.Note),
    Items.NOTE_MUMBOS_MOUNTAIN: LighthouseItemData(98, IC.progression, 0, tags=GroupTag.Note),
    Items.NOTE_RUSTY_BUCKET_BAY: LighthouseItemData(99, IC.progression, 0, tags=GroupTag.Note),
    Items.NOTE_TREASURE_TROVE_COVE: LighthouseItemData(100, IC.progression, 0, tags=GroupTag.Note),
