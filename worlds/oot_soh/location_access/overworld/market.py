...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.MARKET, world, [
        (Locations.MARKET_MARKET_GRASS1, lambda bundle: (is_child(bundle) & (
            can_use_sword(bundle) | has_item(Items.GORONS_BRACELET, bundle)))),
        (Locations.MARKET_MARKET_GRASS2, lambda bundle: (is_child(bundle) & (
            can_use_sword(bundle) | has_item(Items.GORONS_BRACELET, bundle)))),
        (Locations.MARKET_MARKET_GRASS3, lambda bundle: (is_child(bundle) & (
            can_use_sword(bundle) | has_item(Items.GORONS_BRACELET, bundle)))),
        (Locations.MARKET_MARKET_GRASS4, lambda bundle: (is_child(bundle) & (
            can_use_sword(bundle) | has_item(Items.GORONS_BRACELET, bundle)))),
        (Locations.MARKET_MARKET_GRASS5, lambda bundle: (is_child(bundle) & (
            can_use_sword(bundle) | has_item(Items.GORONS_BRACELET, bundle)))),
        (Locations.MARKET_MARKET_GRASS6, lambda bundle: (is_child(bundle) & (
            can_use_sword(bundle) | has_item(Items.GORONS_BRACELET, bundle)))),
        (Locations.MARKET_MARKET_GRASS7, lambda bundle: (is_child(bundle) & (
            can_use_sword(bundle) | has_item(Items.GORONS_BRACELET, bundle)))),
        (Locations.MARKET_MARKET_GRASS8, lambda bundle: (is_child(bundle) & (
            can_use_sword(bundle) | has_item(Items.GORONS_BRACELET, bundle)))),
    ...
    connect_regions(Regions.MARKET, world, [
        ...
        (Regions.MARKET_BAZAAR, lambda bundle: (is_child(bundle) & at_day(
            bundle) & can_open_overworld_door(Items.MARKET_BAZAAR_KEY, bundle))),
        (Regions.MARKET_MASK_SHOP, lambda bundle: (is_child(bundle) & at_day(
            bundle) & can_open_overworld_door(Items.MASK_SHOP_KEY, bundle))),
        (Regions.MARKET_SHOOTING_GALLERY, lambda bundle: (is_child(bundle) & at_day(
            bundle) & can_open_overworld_door(Items.MARKET_SHOOTING_GALLERY_KEY, bundle))),
        (Regions.MARKET_BOMBCHU_BOWLING, lambda bundle: (is_child(bundle)
         & can_open_overworld_door(Items.BOMBCHU_BOWLING_KEY, bundle))),
        (Regions.MARKET_TREASURE_CHEST_GAME, lambda bundle: (is_child(bundle) & at_night(
            bundle) & can_open_overworld_door(Items.TREASURE_CHEST_GAME_BUILDING_KEY, bundle))),
        (Regions.MARKET_POTION_SHOP, lambda bundle: (is_child(bundle) & at_day(
            bundle) & can_open_overworld_door(Items.MARKET_POTION_SHOP_KEY, bundle))),
    ...
    connect_regions(Regions.MARKET_BACK_ALLEY, world, [
        ...
        (Regions.MARKET_BOMBCHU_SHOP, lambda bundle: (at_night(bundle)
         & can_open_overworld_door(Items.BOMBCHU_SHOP_KEY, bundle))),
        ...
        (Regions.MARKET_MAN_IN_GREEN_HOUSE, lambda bundle: (at_night(bundle)
         & can_open_overworld_door(Items.ALLEY_HOUSE_KEY, bundle)))
    ])
    ...
    add_locations(Regions.MARKET_GUARD_HOUSE, world, [
        (Locations.MARKET_10_BIG_POES, lambda bundle: (is_adult(bundle) &
                                                       ((has_bottle(bundle) &
                                                        has_item(Events.CAN_DEFEAT_BIG_POE, bundle)) |
        ...
        (Locations.MARKET_GUARD_HOUSE_CHILD_POT1, lambda bundle: (
            is_child(bundle) & can_break_pots(bundle))),
        ...
        (Locations.MARKET_GUARD_HOUSE_ADULT_POT1, lambda bundle: (
            is_adult(bundle) & can_break_pots(bundle))),
        ...
        (Locations.MARKET_GUARD_HOUSE_CRATE1, lambda bundle: (
            is_child(bundle) & can_break_crates(bundle))),
    ...
    add_events(Regions.MARKET_MASK_SHOP, world, [
        (EventLocations.MARKET_MASK_SHOP_MASKS, Events.CAN_BORROW_MASKS, lambda bundle: (
            has_item(Items.ZELDAS_LETTER, bundle) & has_item(Events.KAKARIKO_GATE_OPEN, bundle))),
        (EventLocations.MARKET_MASK_SHOP_SKULL_MASK, Events.CAN_BORROW_SKULL_MASK, lambda bundle: has_item(Events.CAN_BORROW_MASKS, bundle) & (OptionFilter(CompleteMaskQuest, True) |
                                                                                                                                                 has_item(Events.SOLD_KEATON_MASK, bundle))),
        (EventLocations.MARKET_MASK_SHOP_SPOOKY_MASK, Events.CAN_BORROW_SPOOKY_MASK, lambda bundle: has_item(Events.CAN_BORROW_MASKS, bundle) & (OptionFilter(CompleteMaskQuest, True) |
                                                                                                                                                   has_item(Events.SOLD_SKULL_MASK, bundle))),
        (EventLocations.MARKET_MASK_SHOP_BUNNY_HOOD, Events.CAN_BORROW_BUNNY_HOOD, lambda bundle: has_item(Events.CAN_BORROW_MASKS, bundle) & (OptionFilter(CompleteMaskQuest, True) |
                                                                                                                                                 has_item(Events.SOLD_SPOOKY_MASK, bundle))),
        (EventLocations.MARKET_MASK_SHOP_MASK_OF_TRUTH, Events.CAN_BORROW_MASK_OF_TRUTH, lambda bundle: has_item(Events.CAN_BORROW_MASKS, bundle) & (OptionFilter(CompleteMaskQuest, True) |
    ...
    add_locations(Regions.MARKET_SHOOTING_GALLERY, world, [
        (Locations.MARKET_SHOOTING_GALLERY, lambda bundle: (
            is_child(bundle) & has_item(Items.CHILD_WALLET, bundle)))
    ])
    # Connections
    ...
    add_events(Regions.MARKET_BOMBCHU_BOWLING, world, [
        (EventLocations.MARKET_BOMBCHU_BOWLING_GAME, Events.COULD_PLAY_BOWLING,
         lambda bundle: has_item(Items.CHILD_WALLET, bundle) & bombchus_enabled(bundle))
    ])
    # Locations
    ...
    connect_regions(Regions.MARKET_BOMBCHU_SHOP, world, [
        (Regions.MARKET_BACK_ALLEY, lambda bundle: True_())
    ])
    ...
    add_locations(Regions.MARKET_DOG_LADY_HOUSE, world, [
        (Locations.MARKET_LOST_DOG, lambda bundle: (
            is_child(bundle) & at_night(bundle))),
