...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.DEATH_MOUNTAIN_TRAIL, world, [
        ...
        (Locations.DMT_BEAN_SPROUT_FAIRY2, lambda bundle: is_child(bundle) and can_use(Items.MAGIC_BEAN, bundle) and can_use(Items.SONG_OF_STORMS, bundle) and (has_explosives(bundle) or has_item(Items.GORONS_BRACELET, bundle))),
        (Locations.DMT_BEAN_SPROUT_FAIRY3, lambda bundle: is_child(bundle) and can_use(Items.MAGIC_BEAN, bundle) and can_use(Items.SONG_OF_STORMS, bundle) and (has_explosives(bundle) or has_item(Items.GORONS_BRACELET, bundle))),
        (Locations.DMT_FLAG_SUNS_SONG_FAIRY, lambda bundle: can_use(Items.SUNS_SONG, bundle))
    ])
    # Connections
    connect_regions(Regions.DEATH_MOUNTAIN_TRAIL, world, [
        ...
        (Regions.DEATH_MOUNTAIN_SUMMIT, lambda bundle: blast_or_smash(bundle) or (is_adult(bundle) and ((can_plant_bean(bundle) and has_item(Items.GORONS_BRACELET, bundle)) or (can_use(Items.HOVER_BOOTS, bundle) and can_do_trick(Tricks.DMT_CLIMB_HOVERS, bundle))))), 
        (Regions.DODONGOS_CAVERN_ENTRYWAY, lambda bundle: has_explosives(bundle) or has_item(Items.GORONS_BRACELET, bundle) or is_adult(bundle)), 
    ...
    add_locations(Regions.DEATH_MOUNTAIN_SUMMIT, world, [
        (Locations.DMT_TRADE_BROKEN_SWORD, lambda bundle: is_adult(bundle) and can_use(Items.BROKEN_GORONS_SWORD, bundle)),
        (Locations.DMT_TRADE_EYEDROPS, lambda bundle: is_adult(bundle) and can_use(Items.WORLDS_FINEST_EYEDROPS, bundle)),
    ...
    add_locations(Regions.DMT_COW_GROTTO, world, [
        (Locations.DMT_COW_GROTTO_COW, lambda bundle: can_use(Items.EPONAS_SONG, bundle)),
        (Locations.DMT_COW_GROTTO_BEEHIVE, lambda bundle: can_break_lower_hives(bundle)),
        ...
        (Locations.DMT_COW_GROTTO_SONG_OF_STORMS_FAIRY, lambda bundle: can_use(Items.SONG_OF_STORMS, bundle)),
    ...
    add_locations(Regions.DMT_STORMS_GROTTO, world, [
        ...
        (Locations.DMT_STORMS_GROTTO_GOSSIP_STONE_FAIRY, lambda bundle: call_gossip_fairy(bundle)),
    ...
    add_locations(Regions.DMT_GREAT_FAIRY_FOUNTAIN, world, [
        (Locations.DMT_GREAT_FAIRY_REWARD, lambda bundle: can_use(Items.ZELDAS_LULLABY, bundle))
    ])
    # Connections
