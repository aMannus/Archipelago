...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_events(Regions.GORON_CITY, world, [
        ...
        (EventLocations.GC_STOP_ROLLING_GORON_AS_ADULT, LocalEvents.GC_STOP_ROLLING_GORON_AS_ADULT, lambda bundle: is_adult(bundle) & (has_item(Items.GORONS_BRACELET, bundle) | has_explosives(bundle) | can_use(
