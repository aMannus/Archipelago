...
def set_region_rules(world: "SohWorld") -> None:
    ...
    if world.options.zoras_fountain.value != 2:
        add_events(Regions.ZORAS_DOMAIN, world, [
            (EventLocations.ZD_DELIVER_RUTOS_LETTER, Events.DELIVER_LETTER,
             lambda bundle: can_use(Items.BOTTLE_WITH_RUTOS_LETTER, bundle) & is_child(bundle))
        ])
    add_events(Regions.ZORAS_DOMAIN, world, [
        (EventLocations.ZD_GOSSIP_STONE_SONG_FAIRY, Events.CAN_ACCESS_FAIRIES,
         lambda bundle: call_gossip_fairy_except_suns(bundle)),
        (EventLocations.ZD_NUT_POT, Events.CAN_FARM_NUTS, lambda bundle: True_()),
        ...
        (EventLocations.ZD_KING_ZORA_THAWING, LocalEvents.KING_ZORA_THAWED,
         lambda bundle: is_adult(bundle) & blue_fire(bundle))
    ])
    # Locations
    add_locations(Regions.ZORAS_DOMAIN, world, [
        (Locations.ZD_DIVING_MINIGAME,
         lambda bundle: has_item(Items.BRONZE_SCALE, bundle) & has_item(Items.CHILD_WALLET, bundle) & is_child(
             bundle)),
        (Locations.ZD_CHEST, lambda bundle: is_child(
            bundle) & can_use(Items.STICKS, bundle)),
        (Locations.ZD_KING_ZORA_THAWED,
         lambda bundle: is_adult(bundle) & has_item(LocalEvents.KING_ZORA_THAWED, bundle)),
        (Locations.ZD_TRADE_PRESCRIPTION,
         lambda bundle: is_adult(bundle) & has_item(LocalEvents.KING_ZORA_THAWED, bundle) & can_use(
             Items.PRESCRIPTION, bundle)),
        (Locations.ZD_GS_FROZEN_WATERFALL, lambda bundle: is_adult(bundle) & (hookshot_or_boomerang(bundle) | can_use_any([Items.FAIRY_SLINGSHOT, Items.FAIRY_BOW], bundle) | (can_use(Items.MAGIC_SINGLE, bundle) & (can_use_any([Items.MASTER_SWORD, Items.KOKIRI_SWORD, Items.BIGGORONS_SWORD], bundle))) | (can_do_trick(Tricks.ZD_GS, bundle) & can_jump_slash_except_hammer(bundle))) & can_get_nighttime_gs(bundle)),
        (Locations.ZD_FISH1, lambda bundle: is_child(bundle) & has_bottle(bundle)),
        (Locations.ZD_FISH2, lambda bundle: is_child(bundle) & has_bottle(bundle)),
        (Locations.ZD_FISH3, lambda bundle: is_child(bundle) & has_bottle(bundle)),
        (Locations.ZD_FISH4, lambda bundle: is_child(bundle) & has_bottle(bundle)),
        (Locations.ZD_FISH5, lambda bundle: is_child(bundle) & has_bottle(bundle)),
        ...
        (Locations.ZD_IN_FRONT_OF_KING_ZORA_BEEHIVE_LEFT,
         lambda bundle: is_child(bundle) & can_break_upper_beehives(bundle)),
    ...
    connect_regions(Regions.ZORAS_DOMAIN, world, [
        (Regions.ZR_BEHIND_WATERFALL, lambda bundle: True_()),
        (Regions.LH_FROM_SHORTCUT, lambda bundle: is_child(bundle) & (
            has_item(Items.SILVER_SCALE, bundle) | can_use(Items.IRON_BOOTS, bundle))),
        (Regions.ZD_BEHIND_KING_ZORA,
         lambda bundle: has_item(Events.DELIVER_LETTER, bundle) | OptionFilter(ZorasFountain, ZorasFountain.option_open) | (
    ...
    add_locations(Regions.ZD_BEHIND_KING_ZORA, world, [
        (Locations.ZD_BEHIND_KING_ZORA_BEEHIVE, lambda bundle: is_child(
            bundle) & can_break_upper_beehives(bundle)),
    ])
    # Connections
    ...
    add_locations(Regions.ZD_SHOP, world, [
        (Locations.ZD_SHOP_ITEM1, lambda bundle: can_afford_slot(Locations.ZD_SHOP_ITEM1, bundle)),
        (Locations.ZD_SHOP_ITEM2, lambda bundle: can_afford_slot(Locations.ZD_SHOP_ITEM2, bundle)),
        (Locations.ZD_SHOP_ITEM3, lambda bundle: can_afford_slot(Locations.ZD_SHOP_ITEM3, bundle)),
        (Locations.ZD_SHOP_ITEM4, lambda bundle: can_afford_slot(Locations.ZD_SHOP_ITEM4, bundle)),
        (Locations.ZD_SHOP_ITEM5, lambda bundle: can_afford_slot(Locations.ZD_SHOP_ITEM5, bundle)),
        (Locations.ZD_SHOP_ITEM6, lambda bundle: can_afford_slot(Locations.ZD_SHOP_ITEM6, bundle)),
        (Locations.ZD_SHOP_ITEM7, lambda bundle: can_afford_slot(Locations.ZD_SHOP_ITEM7, bundle)),
        (Locations.ZD_SHOP_ITEM8, lambda bundle: can_afford_slot(Locations.ZD_SHOP_ITEM8, bundle)),
    ])
    # Connections
    ...
    add_locations(Regions.ZD_STORMS_GROTTO, world, [
        (Locations.ZD_FAIRY_GROTTO_FAIRY1, lambda bundle: True_()),
        (Locations.ZD_FAIRY_GROTTO_FAIRY2, lambda bundle: True_()),
        (Locations.ZD_FAIRY_GROTTO_FAIRY3, lambda bundle: True_()),
        (Locations.ZD_FAIRY_GROTTO_FAIRY4, lambda bundle: True_()),
        (Locations.ZD_FAIRY_GROTTO_FAIRY5, lambda bundle: True_()),
        (Locations.ZD_FAIRY_GROTTO_FAIRY6, lambda bundle: True_()),
        (Locations.ZD_FAIRY_GROTTO_FAIRY7, lambda bundle: True_()),
        (Locations.ZD_FAIRY_GROTTO_FAIRY8, lambda bundle: True_()),
    ])
    # Connections
